...
#ifndef MOD_CATALOGSHOP_HTTP_SESSION_H
#define MOD_CATALOGSHOP_HTTP_SESSION_H
...
{
class CatalogShopHttpSession final : public Trinity::Net::Http::AbstractSocket, public std::enable_shared_from_this<CatalogShopHttpSession>
{
public:
    explicit CatalogShopHttpSession(Trinity::Net::IoContextTcpSocket&& socket);
    ~CatalogShopHttpSession();
...
#endif // MOD_CATALOGSHOP_HTTP_SESSION_H
