-- Empty hotfix shells for warband scene layout tables (data comes from client .db2)
...
CREATE TABLE IF NOT EXISTS `warband_scene_animation` (
  `ID` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `warband_scene_anim_chr_spec` (
  `ID` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `warband_scene_placement_filter_req` (
  `ID` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `warband_scene_placement_option` (
  `PositionX` float NOT NULL DEFAULT '0',
  `PositionY` float NOT NULL DEFAULT '0',
  `PositionZ` float NOT NULL DEFAULT '0',
  `ID` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `warband_scene_plcmnt_anim_override` (
  `ID` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `warband_scene_source_info` (
...
CREATE TABLE IF NOT EXISTS `warband_scene_source_info_locale` (
  `ID` int unsigned NOT NULL DEFAULT '0',
