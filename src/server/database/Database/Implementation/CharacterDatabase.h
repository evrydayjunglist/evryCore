...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_UPD_CHARACTER_CURRENCY_QUANTITY_DEBIT,
    ...
    CHAR_SEL_BATTLEPAY_DISTRIBUTIONS,
    CHAR_SEL_BATTLEPAY_DIST_MAX,
    CHAR_INS_BATTLEPAY_DISTRIBUTION,
    CHAR_UPD_BATTLEPAY_DISTRIBUTION_ASSIGN,
    CHAR_UPD_BATTLEPAY_DISTRIBUTION_APPLIED,
    CHAR_UPD_BATTLEPAY_DISTRIBUTION_RETURN,
    CHAR_UPD_BATTLEPAY_DISTRIBUTION_RETURN_BY_CHAR,
    CHAR_DEL_BATTLEPAY_DISTRIBUTION,
    CHAR_DEL_BATTLEPAY_DISTRIBUTION_APPLIED_BY_CHAR,
    CHAR_SEL_BATTLEPAY_CHARACTER,
