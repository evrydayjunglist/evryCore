...
class TC_GAME_API LFGMgr
{
    ...
    public:
        ...
        /// Returns all random and seasonal dungeons for given level, expansion, and Chromie Time mask
        LfgDungeonSet GetRandomAndSeasonalDungeons(uint8 level, uint8 expansion, std::span<uint32 const> contentTuningReplacementConditionMask, uint32 chromieTimeExpansionMask);
