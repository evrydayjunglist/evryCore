...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    // CatalogShop opens at character select; retail answers this on the realm connection with last-catalog companions.
    DEFINE_HANDLER(CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE,                    STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCommerceTokenGetMarketPrice);
    ...
    // Conversion stays unavailable until event items, abilities, quests and replacement rewards can be migrated safely.
    ...
    DEFINE_HANDLER(CMSG_GET_ALL_LICENSED_DECOR_QUANTITIES,                  STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleGetAllLicensedDecorQuantities);
    ...
    DEFINE_HANDLER(CMSG_GET_DECOR_REFUND_LIST,                              STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleGetDecorRefundList);
    ...
    DEFINE_HANDLER(CMSG_GET_LAST_CATALOG_FETCH,                             STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleGetLastCatalogFetch);
    ...
    DEFINE_HANDLER(CMSG_UPDATE_LAST_CATALOG_FETCH,                          STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateLastCatalogFetch);
